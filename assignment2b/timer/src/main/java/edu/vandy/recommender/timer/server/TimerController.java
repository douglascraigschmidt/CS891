...
import static edu.vandy.recommender.timer.common.Constants.EndPoint.*;
import static edu.vandy.recommender.timer.common.Constants.Service.TIMER;
...
public class TimerController {
     ...
     */
    @PostMapping(value = CLEAR_TIMINGS)
