...
public class Constants {
    ...
    public static class EndPoint {
        public static final String GET_ALL_MOVIES = "all_movies";
        public static final String GET_SEARCH = "search";
        public static final String GET_SEARCHES = "searches";
        public static final String SEARCH_QUERY = "/{regex_query}";

        public static class Params {
            public static final String QUERIES_PARAM = "regex_queries";
        }
    }
}
