...
internal object Settings {
    /** Default pref values */
    val DEFAULT_CRAWL_STRATEGY = ImageCrawler.Type.SEQUENTIAL_LOOPS
    val DEFAULT_LOCAL_CRAWL = false
    val DEFAULT_CRAWL_DEPTH = 3
    val DEFAULT_TRANSFORM_TYPES = listOf<Transform.Type>()
    ...
    /** Pref values */
    var crawlStrategy: ImageCrawler.Type by Preference(DEFAULT_CRAWL_STRATEGY, CRAWL_STRATEGY_PREF)
...
fun Range<Int>.scale(t: Int): Range<Int> { return Range(t * lower, t * upper) }
