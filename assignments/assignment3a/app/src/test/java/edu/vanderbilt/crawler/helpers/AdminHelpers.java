...
public class AdminHelpers {
     ...
     *
     * @Param webUrl   The root url to start crawling from.
...
//
// For when Android code is added to this project. Won't compile
// until this happens due to AndroidPlatform not being defined.
//
//    /**
//     * @return Default controller and options for local Java crawl.
//     */
//    public static Controller getDefaultAndroidWebController() {
...
//                .platform(new AndroidPlatform())
//                .options(Options.newBuilder()
//                        .webUrl(getDefaultAndroidLocalRootUrl())
//                        .build())
//                .build();
//    }
