...
public class WebImageCrawlerTest {
    ...
    /**
     * Runs image crawler on the default web url using a NULL_FILTER
     * and then tests the resulting download cache to see if all the
     * downloaded images match the files in the ground-truth directory.
     * The actual testing is performed by the helper class
