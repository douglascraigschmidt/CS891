...
fun buildAllPairs(): List<Pair<BeingManager.Factory.Type, PalantiriManager.Factory.Type>> {
    return BeingManager.Factory.Type.values()
            ...
            .flatMap { bType ->
                PalantiriManager.Factory.Type.values()
                        .filter {
                            it.clazz != PalantiriManager.Factory.NoManager::class.java
                        }
                        .map { pType ->
                            Pair(bType, pType)
                        }
