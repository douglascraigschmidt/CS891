...
open class EnumCheckedListAdapter<T : Enum<T>> constructor(
    ...
    private val enumConstants: Array<T> = enumType.enumConstants as Array<T>
    ...
    override fun newView(inflater: LayoutInflater, position: Int, container: ViewGroup) = inflater.inflate(R.layout.settings_checked_item, container, false)!!
    ...
    override fun newDropDownView(inflater: LayoutInflater, position: Int, container: ViewGroup) = inflater.inflate(android.R.layout.simple_spinner_dropdown_item, container, false)!!
