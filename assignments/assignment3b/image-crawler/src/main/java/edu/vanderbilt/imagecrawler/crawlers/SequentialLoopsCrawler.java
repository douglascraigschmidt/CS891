...
public class SequentialLoopsCrawler
     ...
     * @return An Array of Images where a non-null entry indicate the
     * success an image's transform operations and a null entry
     * indicates failure
     */
    private Array<Image> transformImage(Image image) {
        ...
        Array<Image> transformArray = new Array<>();

        // Process all the URLs for this transform.
        for (Transform transform : mTransforms) {
            // Attempt to create a new cache item for this transform and
