...
public class StampedLockSimpleSemaphoreMgrTest {
    // Model parameters.
    ...
    @InjectMocks
    private StampedLockSimpleSemaphoreMgr mManager;
    ...
    public void buildModel() {
        ...
        StampedLockSimpleSemaphoreMgr manager =
                mock(StampedLockSimpleSemaphoreMgr.class);
    ...
    public void releaseInUsePalantiri() throws IllegalAccessException {
        ...
        ReflectionHelper.injectFieldValueIntoFirstFieldOfType(mManager, Map.class, mPalantiriMapMock);
