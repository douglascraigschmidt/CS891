...
//TODO(monte) this doesn't work yet - prevents select-all refresh. */
...
//            }
    ...
    fun saveSelectionStates(): Bundle? {
        ...
        return if (positions.isNotEmpty()) {
            ...
            bundle.putIntegerArrayList(
                    KEY_SELECTION_POSITIONS, positions as ArrayList<Int>?)
            bundle
        } else {
            null
        }
    ...
    fun restoreSelectionStates(savedStates: Bundle?) {
        if (savedStates != null) {
            selectItems(savedStates.getIntegerArrayList(KEY_SELECTION_POSITIONS))
        }
    }
    ...
    interface OnSelectionListener {
         ...
         * allow it to start.
         */
        fun onActionModeStarted(): Boolean = true

        /**
         * Called when ActionMode has ended or has been cancelled.
         */
        fun onActionModeFinished(): Unit {}
