...
object Settings {
    ...
    //private val VERSION = 4.1f // Assignment 3a
    private val VERSION = 4.2f // Assignment 3b
    ...
    private val DEFAULT_BEING_MANAGER_TYPE = BeingManager.Factory.Type.COMPLETION_SERVICE
