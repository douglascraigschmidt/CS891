package edu.vandy.imagecrawler.utils;
...
import edu.vandy.imagecrawler.utils.helpers.ReflectionHelper;
...
class ArrayHelper {
     ...
     */
    static List<Object> constructMixedInput() {
    ...
    static List<Object> constructInputWithObjectsSameButNotEqual() {
    ...
    static List<Object> constructInputWithObjectsEqualButNotSame() {
    ...
    static List<Object> getInputNoDups(int size) {
    ...
    @SuppressWarnings("SameParameterValue")
    static List<Object> constructDuplicates(Object object, int duplicates) {
    ...
    @SuppressWarnings("SameParameterValue")
    static List<Object> constructObjects(int size, int duplicates) {
        List<Object> objects = new ArrayList<>();
    ...
    static List<Object> constructShuffledMixedInput() {
     ...
     */
    static Object[] getElements(Array array) {
     ...
     * of the private Object[] field "mElementData".
     */
    static void setElements(Array array, Object[] elements) throws IllegalAccessException {
     ...
     */
    static int getSize(Array array) {
     ...
     * of the private Object[] field "mElementData".
     */
    static void setSize(Array array, int size) throws IllegalAccessException {
        ReflectionHelper.injectValueIntoMatchingField(
     ...
     */
    static void assertSameContents(Object[] expected, Object[] objects) {
     ...
     * Helper that compares contents of two arrays for sameness (== operator).
     */
    static void assertSameContentsAndLength(Object[] expected, Object[] objects) {
     ...
     */
    static void assertSameIteratorContents(Iterator expected, Iterator iterator) {
     ...
     * Helper that compares contents of two arrays for sameness (== operator).
     */
    static void assertArrayEquals(Array<Object> expected, Array<Object> array) {
     ...
     */
    static class ObjectIsSameButNotEqual {
        @Override
     ...
     */
    static class ObjectIsEqualButIsNotSame {
        long mValue;
