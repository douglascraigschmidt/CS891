...
object Settings {
    ...
    private val DEFAULT_PALANTIRI_MANAGER_TYPE = PalantirManager.Factory.Type.SPIN_LOCK_SEMAPHORE
    ...
    @JvmStatic
    var palantirManagerType: PalantirManager.Factory.Type
