...
public class TestHelper {
    public static List<Pair<BeingManager.Factory.Type, PalantiriManager.Factory.Type>>
    buildAllPairs() {
    ...
    public static void testStrategyPairs(
            List<Pair<BeingManager.Factory.Type, PalantiriManager.Factory.Type>> pairs,
            int beingCount,
            int palantirCount,
            int iterations,
    ...
    static public void testStrategy(
