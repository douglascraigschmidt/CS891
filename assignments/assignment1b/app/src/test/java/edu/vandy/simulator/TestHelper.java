...
public class TestHelper {
    static List<Pair<BeingManager.Factory.Type, PalantirManager.Factory.Type>>
    buildAllPairs() {
        return Arrays.stream(BeingManager.Factory.Type.values())
                .filter(it -> it.clazz != BeingManager.Factory.NoManager.class)
                .flatMap(bType ->
                        Arrays.stream(PalantirManager.Factory.Type.values())
                                .filter(it -> it.clazz != PalantirManager.Factory.NoManager.class)
    ...
    static void testStrategyPairs(
            List<Pair<BeingManager.Factory.Type,
                    PalantirManager.Factory.Type>> pairs,
            int beingCount,
            int palantirCount,
            int iterations,
    ...
    static void testStrategy(
            ...
            PalantirManager.Factory.Type palantirManager,
            int beingCount,
            int palantirCount,
            int iterations,
            float animationSpeed,
