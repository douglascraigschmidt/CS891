 ...
 */
@Rubric
class Assignment_1A_IntegratedTest {
    private val beingManager = BeingManager.Factory.Type.RUNNABLE_THREADS
    private val palantirManager = PalantiriManager.Factory.Type.ARRAY_BLOCKING_QUEUE
