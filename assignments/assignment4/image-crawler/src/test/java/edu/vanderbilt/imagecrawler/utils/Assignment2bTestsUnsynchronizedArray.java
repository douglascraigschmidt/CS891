// Ignore package error: utils is used so that tests can access protected methods!
...
/**
 * Test program for the Java 7 and 8 features of the
 * UnsynchronizedArray class.  Note that since the sample input data
 * contains objects whose equals() methods always returns false, care
 * must be used to use assertSame() instead of assertEquals() where
 * necessary.
 */
public class Assignment2bTestsUnsynchronizedArray {
    /**
    ...
    public void testConstructorWithValidCapacityInput() {
        for (int i = 0; i <= mMaxTestSize; i++) {
            Array<Integer> array = new UnsynchronizedArray<>(i);
    ...
    public void testDefaultConstructor() {
        Array<Object> array = new UnsynchronizedArray<>();
    ...
    public void testConstructorWithNonEmptyCollectionInput() {
        ...
        Array<Object> array = new UnsynchronizedArray<>(input);
        Object[] data = ArrayHelper.getElements(array);
    ...
    public void testConstructorWithEmptyCollectionInput() {
        ...
        Array<Object> array = new UnsynchronizedArray<>(emptyCollection);
        Object[] data = ArrayHelper.getElements(array);
    ...
    public void testIsEmptyWithZeroCapacityBlackBox() {
        Array<Object> array = new UnsynchronizedArray<>(0);
    ...
    public void testIsEmptyWithPositiveCapacityBlackBox() {
        Array<Object> array = new UnsynchronizedArray<>(1);
    ...
    public void testAddAllEmptyArrayReturnsNotChanged() {
        ...
        Array<Object> emptyInput = new UnsynchronizedArray<>(10);
    ...
    public void testForEachUndergraduate() {
        ...
        Array<Object> original = new UnsynchronizedArray<>(mShuffledMixedInput);
        assertArrayEquals(mShuffledMixedInput.toArray(), original.toArray());

        Array<Object> a1 = spy(new UnsynchronizedArray<>(mShuffledMixedInput));
        assertArrayEquals(mShuffledMixedInput.toArray(), original.toArray());

        Array<Object> a2 = new UnsynchronizedArray<>();
    ...
    public void testReplaceAll() {
        ...
        Array<Long> array = new UnsynchronizedArray<>(expected);
    ...
    public void runSpliteratorTest19() {
        Array<Long> array = new UnsynchronizedArray<>();
