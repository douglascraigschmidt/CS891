...
public class CompletableFuturesCrawler1
    ...
    protected CompletableFuture<Integer> mZero = null;
    ...
    protected int performCrawl(String pageUri,
        ...
        // TODO -- you fill in here (replace 0 with proper code).
        return 0;
    }
     ...
     */
    protected CompletableFuture<Integer>
    combineResultsAsync(CompletableFuture<Integer> imagesOnPageFuture,
                        CompletableFuture<Integer> imagesOnPageLinksFuture) {
