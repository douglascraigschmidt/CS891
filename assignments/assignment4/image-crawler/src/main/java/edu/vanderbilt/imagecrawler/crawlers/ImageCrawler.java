...
public abstract class ImageCrawler
    ...
    public void run() {
        ...
        try {
            ...
            // Note that we don't reset the mCancelled flag because
            // the Framework's thread pool might not have cancelled
            // all running threads. Instead, we will clear the cancelled
            // flag when the next run() call is made.
        }
    }
    ...
    protected Array<URL> getImagesOnPage(Crawler.Page page) {
        ...
        return page
            ...
            // Trigger intermediate operations and collect elements
            // into the array.
            .collect(toArray());
    }
