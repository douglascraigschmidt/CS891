...
/**
 * This implementation strategy uses the Java 8 fork-join pool
 ...
 * are stored in files that can be displayed to the user.  Graduate
 * students should use Java 8 sequential streams to implement the
 * fork-join logic, whereas streams are optional for undergraduate
 * students (who can simply use Java 7 for-each loops).
 */
public class ForkJoinCrawler1
        ...
        protected Integer compute() {
            ...
            // accessible via this page.
                ...
                if (Assignment.isGraduateTodo()) {
                    ...
                    // Use a Java 8 sequential stream to join/sum all
                    ...
                    // TODO -- you fill in here.
                    Array<ForkJoinTask<Integer>> forks = makeForkJoinArray();

                    // Iterate through all images and hyperlinks
                    // on this page.
                    for (WebPageElement pageElement : page.getPageElements(IMAGE, PAGE))
                        if (pageElement.getType() == IMAGE) {
                            // If page element is an image create
                            // the appropriate task object that
                            // processes the image, fork it, and
                            // add it to the array of forked
                            // tasks.

                            // TODO -- you fill in here.
                        } else {
                            // If page element is a page create
                            // the appropriate task object that
                            // crawls hyperlinks recursively, fork
                            // it, and add it to the array of
                            // forked tasks.
                    ...
                    // A barrier that joins all the tasks in the array of forked tasks.
                    // TODO -- you fill in here.
        ...
        protected Integer compute() {
            ...
            if (rawImage != null) {
                if (Assignment.isGraduateTodo()) {
                    ...
                    // Use a Java 8 sequential stream to join all the
