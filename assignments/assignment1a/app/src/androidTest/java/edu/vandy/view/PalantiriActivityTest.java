...
import edu.vandy.app.common.Utils;
import edu.vandy.app.ui.screens.main.MainActivity;
...
public class PalantiriActivityTest {
    ...
    public void palantiriActivityTest() {
        ...
        ViewInteraction startButton = onView(
                allOf(withId(R.id.progressFab), isDisplayed()));
        ...
        List<Pair<Integer, Integer>> pairs =
                Stream.of(
                        Pair.create(R.id.settingsPalantirSeekBar, PALANTIRI),
                        Pair.create(R.id.settingsBeingsSeekBar, BEINGS),
                        Pair.create(R.id.settingsIterationsSeekBar, ITERATIONS),
                        Pair.create(R.id.settingsAnimationSpeedSeekBar, SPEED)
