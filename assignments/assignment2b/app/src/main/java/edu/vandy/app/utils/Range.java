...
/**
 * TODOx: temporary copy of android.util.Range class to work around target SDK 28
 * bug the prevents Gson from converting any Range<Int> object to JSON.
 *
...
public final class Range<T extends Comparable<? super T>> {
    ...
    private @NonNull
    <R> R checkNotNull(final R reference, final Object errorMessage) {
        if (reference == null) {
    ...
    private static <R> int hashCodeGeneric(R... array) {
        if (array == null) {
            return 0;
        }
        int h = 1;
