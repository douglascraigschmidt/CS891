...
public class SimpleSemaphoreWithReentrantLockTest {
    private static final int PALANTIRI_COUNT = 5;

    @Mock
    public ReentrantLock mLockMock;
    @Mock
    ...
    public void testAcquireOne() throws InterruptedException {
        if (Helpers.isLockSolution(mSimpleSemaphore)) {
            System.out.println("Lock solution ignored by ReentrantLock solution tests.");
            return;
        }
