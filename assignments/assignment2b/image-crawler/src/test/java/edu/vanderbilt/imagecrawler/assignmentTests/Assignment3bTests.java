 ...
 */
public class Assignment3bTests {
    /**
     * PARALLEL_STREAMS1
     *
     ...
     */
    @Test
    public void parallelStreamsCrawler1Test() throws Exception {
     ...
     */
    @Test
    public void parallelStreamsCrawler2Test() throws Exception {
        Controller controller = DefaultController.build(true);

        // Perform the local crawl using the completable futures crawler.
        AdminHelpers.downloadIntoDirectory(
                ImageCrawler.Type.PARALLEL_STREAMS2,
                controller,
                false);
