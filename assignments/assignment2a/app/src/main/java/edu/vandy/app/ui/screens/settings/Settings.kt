...
object Settings {
    ...
    val SIMULATION_THREAD_COUNT_PREF = "SimulationThreadCountPref"
    val SIMULATION_THREAD_COUNT_RANGE_PREF = "SimulationThreadCountRangePref"
    ...
    private val DEFAULT_THREAD_COUNT = DEFAULT_BEING_COUNT
    ...
    val THREAD_COUNT_RANGE = Range(1, SimulationView.MAX_BEING_COUNT)
    ...
    @JvmStatic
    var threadCountRange: Range<Int>
            by Preference(THREAD_COUNT_RANGE,
                    SIMULATION_THREAD_COUNT_RANGE_PREF)
    @JvmStatic
    ...
    @JvmStatic
    var threadCount: Int
            by Preference(DEFAULT_THREAD_COUNT,
                    SIMULATION_THREAD_COUNT_PREF)
