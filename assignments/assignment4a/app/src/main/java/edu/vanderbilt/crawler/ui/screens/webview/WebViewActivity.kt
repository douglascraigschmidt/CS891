...
import edu.vanderbilt.crawler.extensions.visible
...
class WebViewActivity : AppCompatActivity(), KtLogger {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        copyFab.setOnClickListener {
            copyFab.hide(object : FloatingActionButton.OnVisibilityChangedListener() {
        ...
        // Hide FAB so that it can aninimate into view
        // from onResume().
        copyFab.visibility = View.INVISIBLE
